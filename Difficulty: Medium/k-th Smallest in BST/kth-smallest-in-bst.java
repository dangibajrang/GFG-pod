...
// Inorder Traversal (Left → Root → Right) results in a sorted sequence,
// we can find the K-th smallest element by performing an inorder traversal and stopping at the K-th node.
