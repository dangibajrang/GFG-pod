...
class Solution {
    ...
    public DLLNode reverseDLL(DLLNode head) {
        ...
        while (current != null) {
            ...
            current = current.prev; // We use current.prev because we swapped the pointers
        }

        // After the loop, temp will point to the new head, which is the previous last node
        if (temp != null) {
            head = temp.prev;
        }
